...
export class Riddlevox implements IRiddlevox {
  constructor(options?: IRiddlevoxOptions) {
    ...
    this.form.classList.add(
      this.options.position === "bottom-left"
        ? "Riddlevox-bottom-left"
        : "Riddlevox-bottom-right"
    );
   ...
   */
  private formQuery = <T extends HTMLElement = HTMLElement>(
    selector: string
  ) => {
  ...
  private configureDefaults: (
    options?: IRiddlevoxOptions
  ) => IRiddlevoxOptions = (options) => {
  ...
  private onFormSubmit: (e: MouseEvent) => void = (e) => {
    ...
    if (typeof this.options.onConversion === "function") {
      var name = (<HTMLInputElement>(
        this.form.querySelector("input.Riddlevox-fname")
      )).value;
      var email = (<HTMLInputElement>(
        this.form.querySelector("input.Riddlevox-email")
      )).value;
  ...
  public start: () => Riddlevox = () => {
    ...
    this.form.style.maxHeight =
      (<HTMLElement>this.form.querySelector(".Riddlevox-header")).offsetHeight +
      "px";
  ...
  public open: (e?: Event) => Riddlevox = (e) => {
    ...
    if (this.isDestroyed) {
      throw new Error(
        "Riddlevox has been destroyed. Please create a new instance of Riddlevox."
      );
    }
